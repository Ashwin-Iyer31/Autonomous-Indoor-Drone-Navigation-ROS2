...
global yawSetpoint, thrust, pitchSetpoint, rollSetpoint, altSetpoint, alt
yawSetpoint = 0
thrust = 1500
pitchSetpoint = 0
rollSetpoint = 0
...
class PoseSub(Node):
    ...
    def listener_callback(self, msg):
        ...
        (fUpdated, err_roll.data, err_pitch.data, err_yaw.data) = PID(roll, pitch, yaw, alt, f, yawSetpoint, thrust, pitchSetpoint, rollSetpoint, altSetpoint)
...
class AltSub(Node):
    ...
    def listener_callback(self, msg):
        ...
        index = 0
        try:
           index = msg.name.index('my_bot::base_link')
        except ValueError:
            pass
        alt = msg.pose[index].position.z
...
class CmdVelSub(Node):
    ...
    def listener_callback(self, msg):
        ...
        pitchSetpoint = msg.linear.x #Up is positive
